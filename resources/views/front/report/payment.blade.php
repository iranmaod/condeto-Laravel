	...
	<div class="container run_report">
			...
			<form action="{{route('payment.submit')}}" method="post"  enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="field">					
						<input type="text" name="tenant_name" id="tenant_name" placeholder="All Tenants" />
						<div class="tenant_list ajax_search_list">
							<ul>							
							</ul>
						</div>
				...
				<div class="row">
					...
					<div class="chk_row">
						<input type="checkbox" name="chkAvgTime" value="1" id="chkAvgTime" /><label for="chkAvgTime"></label><span>Overall Data</span>
					</div>
				...
				<div class="row">
					<div class="field button_group">
						<button id="run_report_button" class="btn">Run Report</button>
					</div>					
				</div>
