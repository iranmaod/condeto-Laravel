...
<div class="main_content">
	...
	<div class="container run_report">
			...
			<form action="{{route('facility.submit')}}" method="post" enctype="multipart/form-data">
                @csrf		
				...
				<div class="row">
					<h3>Hours Between:</h3>
					<div class="field">					
						<select name="hour_between_start" id="hour_between_start">
															<option value="00:00">								
																			Midnight
					...
					<div class="field">					
						<select name="hour_between_end" id="hour_between_end">
															<option value="0">								
																			Midnight
				...
				<div class="row">
					<h3>Select data:</h3>
					<div class="chk_row" style="width:300px">
						<input type="checkbox" name="chkRequests" value="1" id="chkRequests" /><label for="chkRequests"></label><span>Percentage of bookings per facility</span>
					</div>
					
					<div class="chk_row">
						<input type="checkbox" name="chkAvgTime" value="1" id="chkAvgTime" /><label for="chkAvgTime"></label><span>Average Bookings</span>
					</div>
					
					<div class="chk_row">
						<input type="checkbox" name="chkBarChart" value="1" id="chkBarChart" /><label for="chkBarChart"></label><span>Chart by day of week</span>
					</div>
				</div>
