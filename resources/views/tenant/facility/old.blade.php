             ...
             <form action="" method="post">
                 ...
                 <div class="facility_details">					
                     <div class="facility_image_text_container">
                         <p style="display: block" id="facility_image1">
                            <img src="{{asset('img/facility_1.jpg')}}" alt="">
                         </p>
                         <p style="display: none" id="facility_image2">
                            <img src="{{asset('img/facility_2.jpg')}}" alt="">
                         </p>
                         <p style="display: none" id="facility_image3">
                     ...
                     <p class="facility_location"><strong>Location : </strong> <span id="facility_location"></span></p>
                     ...
                     <p class="cost_per_block"><strong>Cost Per Block : </strong> <span id="cost_per_block"></span></p>
                 </div>
                 
                 <h3>Scroll to see availability for <span class="availability_date"></span>:</h3>
