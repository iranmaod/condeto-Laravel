...
<div class="main_content">
	...
	<div style="margin:-24px auto !important; margin-left:-84px !important" class="container apply_form">
        <div class="row">
            <div style="display: block" id="expand" class="apt_apply_nav_and_logo">
				<div onclick="myExpand()" class="step_menu_icon"><span class="fa fa-list"></span><p>Collapse</p></div>
                <ul id="apt_apply_steps" class="apt_apply_steps">
                    <li onclick="showList();" class="active">
                        <span class="fa fa-building"></span><p>Apartments</p>
                    </li>
					
					<li onclick="showTerm();" class="loggedInRestricted">
                        <span class="fa fa-certificate"></span><p>Lease Term</p>
                    </li>
					
                        <li onclick="showRental();" class="loggedInRestricted">
                            <span class="fa fa-pencil-alt"></span><p>Rental Terms</p>
                        </li>
                    
                    <li onclick="showPersonal();" class="loggedInRestricted"><span class="fa fa-user"></span><p>Personal</p></li>
                    <li onclick="showAddress();" class="loggedInRestricted"><span class="fa fa-home"></span><p>Address</p></li>
                    <li onclick="showAdditional();" class="loggedInRestricted"><span class="fa fa-info"></span><p>Additional</p></li>
                    <li onclick="showFinancial();" class="loggedInRestricted"><span class="fa fa-hashtag"></span><p>Financial</p></li>
                    <li onclick="showDocuments();" class="loggedInRestricted"><span class="fa fa-file"></span><p>Documents</p></li>
                    <li onclick="showPayment();" class="loggedInRestricted"><span class="fa fa-credit-card"></span><p>Payment</p></li>
                    <li onclick="showComplete();" class="loggedInRestricted"><span class="fa fa-check-circle"></span><p>Complete</p></li>
                </ul>
        ...
        <div class="row">
            <div class="col-xs-8 col-md-8 col-md-offset-2">
                    ...
                    <div class="apt_form" id="apt_form">
                        ...
                        <div id="Thelist" data-menu-trigger="0" class="property_list_section apt_section active" data-header_title="What's Available?" data-header_text="Please select from the available apartment homes listed.">
            ...
            <form action="{{route('apartment.applynew')}}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="property_container">
                                ...
                                <div class="property_row">
                                    <div class="property_sel">
                                        <input type="radio" name="property_sel" value="{{$item->id}}" class="property_selector"></div><div class="property_name"><p><span class="price">${{$item->fee}} /mo </span>{{$item->name}}, 
                                    
                                   {{$item->address}} , RIDGEWOOD, NY, 11385</p></div><p></p><div id="{{$item->id}}" onclick="passId(this.id);" class="property_links">
                                    {{-- <input name="property" value="{{$item->id}}" type="submit"> --}}
                                    <span class="apply_button">Apply</span>
                                    <a href="" target="_blank"><i class="fa fa-search"></i></a></div></div>
                                     <?php 
                                    //  $somevar = $_GET["uid"];
                                    //  print_r($somevar);
                                    ?> 
                  ...
                  {{-- <button type="submit" class="btn btn-primary" id="">Submit</button>
						...
						<div id="Theterm" data-menu-trigger="1" class="lease_section apt_section" data-header_title="What's Available?" data-header_text="Please select from the available apartment homes listed.">
                            <h2><img src="{{asset('img/cube.png')}}" alt="Length of Lease Duration"/>Length of Lease Duration</h2>
							<div class="apt_field_block">
                                ...
                                $id = $_GET["uid"];
                                //  print_r($somevar);
                                $property_fee = Property::find($id);
                                } 
                                
                                ?> 
								
								<p class="rent_cost">Rent: <span>
                                    @if(isset($property_fee))
                                    ${{$property_fee->fee}}
                                    @else
                                    00
                                    @endif
                            ...
                            <button onclick="showRental();" style="margin: 100px 60px" type="button" class="btn btn-primary" id="">Save and Continue</button>
                        </div>
						
                      
                            <div id="Therental" data-menu-trigger="2"
                                ...
                                <h2><img src="{{asset('img/signed_paper.png')}}" alt="Rental Terms" />Rental Terms &amp; Conditions</h2>
                                ...
                                <div class="apt_field how_hear_block">
                                    ...
                                    <button onclick="showPersonal();" type="button" class="btn btn-primary" id="">Save and Continue</button>
                            ...
                            <div id="Thepersonal" class="apt_section personal_information" data-menu-trigger="3" id="personal_information" data-header_title="Personal Information" data-header_text="Fields with a red border are required. Thank you again for applying, please look over the information below and verify it for correctness prior to submitting your application.">

                                <h2><img src="{{asset('img/user-blue.png')}}" alt="Personal Information">Personal Information</h2>
                                ...
                                <div class="apt_field apt_field_first_name">
                                    ...
                                    <div class="apt_field_fieldx">
                                        ...
                                        <div class="apt_field_block field_first_name">
                                            ...
                                            <input class="required" value="" required="required" name="first_name" type="text" id="first_name" data-validation-engine="validate[required]" data-errormessage-value-missing="Please enter your first name">
                                        </div>
                                        ...
                                        <div class="apt_field_block field_last_name">
                                            ...
                                            <input class="required validate[required]" value="" required="required" name="last_name" type="text" id="last_name" data-validation-engine="validate[required]" data-errormessage-value-missing="Please enter your last name">
                                        </div>
                                ...
                                <div class="apt_field">
                                    <div class="apt_field_fieldx">
                                        ...
                                        <div class="apt_field_block field_phone">
                                            ...
                                            <input class="required" required="required" value="" name="phone" type="tel" id="phone" data-validation-engine="validate[required]" data-errormessage-value-missing="Please enter your phone">
                                        </div>
                                ...
                                <div class="apt_field">
                                    <div class="apt_field_fieldx">
                                        ...
                                        <div class="apt_field_block field_alternate_phone">
                                            ...
                                            <input value="" name="alternative_phone" type="tel" id="alternative_phone" />
                                        </div>
                                ...
                                <div class="apt_field">
                                    <div class="apt_field_fieldx">
                                        ...
                                        <div class="apt_field_block field_email_address field_width_445">
                                            ...
                                            <input class="required" type="email" name="email_address" value="" id="email_address" data-validation-engine="validate[required,custom[email]]" data-errormessage-value-missing="Email is required!" >
                                ...
                                <button onclick="showAddress();" type="button" class="btn btn-primary" id="">Save and Continue</button>
                            </div>

                            
                          

                            <div id="Theaddress" class="apt_section" data-menu-trigger="4">
                                <h2><img src="{{asset('img/user-blue.png')}}" alt="Personal Information">Current Address</h2>
                                <p class="sub_header_intro">Fields with a red border are required</p>
                                ...
                                <button  onclick="showAdditional();" type="button" class="btn btn-primary" id="">Save and Continue</button>
                            </div>

                         

                            <div id="Theadditional" class="apt_section" data-menu-trigger="5">
                                <h2><img src="{{asset('img/user-blue.png')}}" alt="Personal Information">Additional Questions</h2>
                                ...
                                <button onclick="showFinancial();" type="button" class="btn btn-primary" id="">Save and Continue</button>
                            </div>

                          

                            <div id="Thefinancial" class="apt_section" data-menu-trigger="6">
                                <h2><img src="{{asset('img/user-blue.png')}}" alt="Personal Information">Financial Details</h2>
                                ...
                                <div class="apt_field">
                                    <div class="apt_field_fieldx">
                                        <div class="apt_field_block field_bank_account_balance">
                                            ...
                                            <input name="bank_account_balance" value="" type="number" id="bank_account_balance">
                                ...
                                <button  onclick="showDocuments();" type="button" class="btn btn-primary" id="">Save and Continue</button>
                            </div>
                          

                            <div id="Thedocument" class="apt_section document_section" data-menu-trigger="7">
                                <h2><img src="{{asset('img/user-blue.png')}}" alt="Personal Information">Upload Documents</h2>
								...
								<button  onclick="showPayment();" type="submit" class="btn btn-primary" id="">Save and Continue</button>
                            </div>

                            <div id="Thepayment" class="apt_section payment_information " id="payment_section" data-menu-trigger="8" data-header_title="Payment Information" data-header_text="Fields a red border are required. By continuing, you are providing acceptance and authorization to AptApply, Inc. to obtain information from your personal credit file." >
                                <h2><img src="{{asset('img/payment.png')}}" alt="Payment Information">Payment Information</h2>
                                <p class="sub_header_intro">Fields with a red border are required</p>
                                <?php
                                if(isset($_GET['uid']))
                                {
                                ...
                                @if(isset($property))
                                <a style="margin: 200px" type="submit" class="btn btn-primary" href="{{route('payment.application',['price' => 250, 'reference' => $payment->reference , 'id' => $property->id])}}">Submit card payment</a>
                                @endif 
                              </div>
                              
                            
                            <div id="Thecomplete" class="apt_section" data-menu-trigger="9" data-action-form-save="true">
                                <h2>Complete</h2>
...
<script>
    var term = document.getElementById("Theterm");
    var list = document.getElementById("Thelist");
    var rental = document.getElementById("Therental");
    var personal = document.getElementById("Thepersonal");
    var address = document.getElementById("Theaddress");
    var additional = document.getElementById("Theadditional");
    var financial = document.getElementById("Thefinancial");
    var thedocument = document.getElementById("Thedocument");
    var payment = document.getElementById("Thepayment");
    var complete = document.getElementById("Thecomplete");

function passId(myid){
    // alert(myid);
    // alert(myid);
    var property_id = myid;
    window.location.href='http://127.0.0.1:8000/apply?uid=' + property_id;
...
function showDocuments(){
    ...
    payment.style.display = "none";
    complete.style.display = "none";
    thedocument.style.display = "block";
}
...
function myExpand() {
   ...
   element.classList.toggle("expanded_menu");
}
