...
<div class="main_content">
    ...
    <div class="container payment_container">
         <div class="row">
             <h2><img src="{{asset('img/payment.png')}}" alt="Payment Information">Application Payment Information<span class="payment_title_detail">(Awaiting Payment)</span></h2>
             
                         
             <h3 class="amount_required">Total: <span>${{$application_price}}</span></h3>						
             ...
             <form action="{{route('application.payment.success',['reference' => $payment->reference , 'id' => $application_id])}}" method="post"
                ...
                {{-- <h3>Amount to pay:</h3> --}}
                 <div class="row">
                     <div class="field" id="payment_amount_container">
                         ...
                         <input name="rent_payment_amount" type="hidden" value="{{$application_price}}" id="rent_payment_amount">
