...
<div class="main_content">
    ...
    <div class="container payment_container">
         <div class="row">
             <h2><img src="{{asset('img/payment.png')}}" alt="Payment Information">Rent Payment Information<span class="payment_title_detail">(Unknown)</span></h2>
             
                         
             <h3 class="amount_required">Total: <span>${{$payment->amount - $payment->amount_paid}}</span></h3>						
             ...
             <form action="{{route('payment.success',$payment->reference)}}" method="post"
                ...
                <h3>Amount to pay:</h3>
                 <div class="row">
                     <div class="field" id="payment_amount_container">
                         ...
                         <input name="rent_payment_amount" type="text" value="{{$payment->amount - $payment->amount_paid}}" id="rent_payment_amount">
                 ...
                 <div class="row">				
                     <div class="field full_width">						
                         <label for="payment_method">Please select the payment method. You can pay by credit card or if you have <a href="/profile">linked a bank account</a> you can pay via ACH.</label>
