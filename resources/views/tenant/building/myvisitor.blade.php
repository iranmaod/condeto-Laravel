...
<div class="main_content">
    ...
    <div class="container tenant_repairs">
        ...
        <div class="main_block">
            <h2><img src="{{asset('img/event.png')}}" />Pending Visitors</h2>	
            ...
            <h2 style="margin-top:30px;"><img src="{{asset('img/event.png')}}" />Overdue/Un-Scheduled Visitors</h2>	
            <ul class="tasks">
                <li>				
                ...
                <div class="task_container" data-id="369">										
                    <div class="inline_content">
                        ...
                        <p><strong>Date Scheduled:</strong> {{ date('d F Y h:i:s A', strtotime($item->start_time))  }}</p>
                            ...
                            <p>Items included in the Visitors</p>
                            <ul class="task_items">
                    ...
                    <p><a href="my_visitors/{{$item->id}}" class="btn mini_button">View Visitors Request</a></p>
                </div>								
            </li>
