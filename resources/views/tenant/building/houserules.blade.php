...
<div class="main_content">
    ...
    <div class="container building_resources">
        ...
        <h2><img src="{{asset('img/resources.png')}}" />Resources - House Rules</h2>
            
        <ul class="standard_listing resource_listing">
                        
                                <li>
                        <div class="resource_container" data-id="304">
                            <p>Title : House Rules and Regulations.</p>
                            <p>House Rules and Regulations document<br />
                            Date Published : <date>{{date('F d, Y')}}</date>
                            </p>						
                            <p><a class="button mini_button" href="{{asset('apt_apply_assets/house_rules_and_regulations..pdf')}}" target="_blank">Download</a></p>
                        </div>
                    </li>
