...
<div class="main_content">
    ...
    <div class="container tenant_repairs">
        ...
        <div class="main_block">
            <h2><img src="{{asset('img/event.png')}}" />Pending Deliveries</h2>	
            ...
            <h2 style="margin-top:30px;"><img src="{{asset('img/event.png')}}" />Overdue/Un-Scheduled Deliveries</h2>	
            <ul class="tasks">
                <li>				
        <ul style="display:block;">
                ...
                <div class="task_container" data-id="369">										
                    <div class="inline_content">
                        ...
                        <p><strong>Date Scheduled:</strong> {{ date('d F Y h:i:s A', strtotime($item->start_time))  }}</p>
                            ...
                            <p>Items included in the delivery</p>
                            <ul class="task_items">
                    ...
                    <p><a href="my_deliveries/{{$item->id}}" class="btn mini_button">View Delivery Request</a></p>
                </div>								
            </li>
            ...
            <h2 style="margin-top:30px;"><img src="{{asset('img/calendar-tick.png')}}" />Completed Deliveries</h2>	
            <ul class="tasks">
                <li>				
        <ul style="display:block;">					
            @foreach ($comp_delivery as $item)
