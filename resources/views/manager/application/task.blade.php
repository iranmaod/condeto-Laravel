...
<div class="">
    ...
    <div class="container task_listing repair_listing_page">
                    <h2 class="d-flex"><img src="{{asset('img/event.png')}}" />Pending  visitors
                    </h2>
        ...
        <ul>
            ...
            <li>
                <div class="task_container">												
                    <div class="inline_content">
                        ...
                        <p><strong>Expected Visitor Date:</strong> {{date('F d, Y h:i a',strtotime( $item->start_time))}}</p>
                    </div>														
                    ...
                    ?>
                     ...
                     @endif
                        ...
                        <div class="items_in_request">
                            ...
                            <p><a href="/tasks_lists/{{$item->id}}" class="btn mini_button">View Visitor Request</a></p>
                </div>
            </li>	
            ...
            <div class="task_listing_details">
                    <h2 style="margin-top:30px;"><img src="{{asset('img/event.png')}}" />Incomplete  Visitors</h2>
            ...
            <h2 style="margin-top:30px;"><img src="{{asset('img/calendar-tick.png')}}" />Completed  Visitors</h2>
            <ul>
