...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Community Categories</h1>
	...
	<li id="search_toggle"><a href="{{route('community.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('community.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
			...
			<div class="col-md-12">
					...
					<form  method="POST" action="{{route('community.search')}}">
						@csrf
						<section class="widget-content">
							<div class="filter_section_row" data-label="Search">
						...
						<table class="table table-striped table-bordered table-hover datatable">
							<thead>
								<tr>
									...
									<th id="th_ap2">Category</th>
									<th id="th_ap">Default</th>
									<th id="th_img"></th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a style="margin-right:7px" class="btn btn-xs btn-success" href="{{route('community.edit',$item->id)}}">
										<i class="fa fa-pencil"></i></a>
										<a style="margin-right:7px" class="btn btn-xs btn-warning" href="{{route('community.delete',$item->id)}}">
