...
@section('content')
<div class="">
    <h1 class="mainTitle"> Edit Community Category
</h1>
...
<div class="col-md-12">
    ...
    <section class="widget admin_view_record" id="RecordSection">
        ...
        <section class="widget-content">	
            ...
            <form action="{{route('community.update',$category->id)}}" method="post" enctype="multipart/form-data">							
					@csrf		
                    <div class="form_field">							
                        <label style="width:100%">Complex: </label>								
                        <select value="{{$category->object_id}}" id="complex_id" name="complex_id"  data-placeholder="Select Complex" class="chosen-select">
                    ...
                    <div class="form_field">
                        ...
                        <input value="{{$category->cate_name}}" type="text" id="name" name="name" />
                    </div>							
