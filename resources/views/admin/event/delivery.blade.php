...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Deliveries</h1>
	...
	<li id="search_toggle"><a href="{{route('delivery.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('delivery.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
			...
			<div class="col-md-12">
					...
					<form  method="POST" action="{{route('delivery.search')}}">
						@csrf
						<section class="widget-content">
							<div class="filter_section_row" data-label="Search">
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_fields" label="Fields">
													<option data-type="Complex" value="role">ID</option>
													<option data-type="Complex" value="role">Start Date</option>
													<option data-type="Complex" value="role">End Date</option>
												</optgroup>
											</select>
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
													...
													<option data-type="Complex" value="start_time">Start Date</option>
													<option data-type="Complex" value="end_time">End Date</option>
											</select>
										  </div>
										</div>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							<thead>
								<tr>
									...
									<th id="th_ap2">Start Date</th>
									<th id="th_ap">End Date</th>
									<th id="th_ap">Type</th>
									<th id="th_ap">Message</th>
									<th id="th_ap">User</th>
									<th id="th_ap">Assigned to</th>
