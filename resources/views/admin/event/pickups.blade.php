...
@section('content')
 ...
 <div class="">
	...
	<li id="search_toggle"><a href="{{route('pickups.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('pickups.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
			...
			<div class="col-md-12">
					...
					<form  method="POST" action="{{route('pickups.search')}}">
						@csrf
						<section class="widget-content">
							<div class="filter_section_row" data-label="Search">
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_fields" label="Fields">
													...
													<option data-type="Complex" value="end_time">End Date</option>												</optgroup>
											</select>
										  </div>
										</div>
