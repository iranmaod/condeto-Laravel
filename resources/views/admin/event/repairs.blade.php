...
@section('content')
 ...
 <div class="">
	...
	<li id="search_toggle"><a href="{{route('repairs.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('repairs.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
			...
			<div class="col-md-12">
					...
					<form  method="POST" action="{{route('repairs.search')}}">
						@csrf
						<section class="widget-content">
							<div class="filter_section_row" data-label="Search">
