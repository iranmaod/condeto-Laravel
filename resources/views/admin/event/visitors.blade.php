...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Visitors</h1>
	...
	<li id="search_toggle"><a href="{{route('visitors.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('visitors.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
			...
			<div class="col-md-12">
					...
					<form  method="POST" action="{{route('visitors.search')}}">
						@csrf
						<section class="widget-content">
							<div class="filter_section_row" data-label="Search">
