...
@section('content')
 ...
 <div class="">
	...
	<li id="search_toggle"><a href="{{route('message.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('message.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_fields" label="Fields">
													<option data-type="Complex" value="id">Message</option>
												</optgroup>
											</select>
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
												...
												<option data-type="Complex" value="message">Message</option>
											</select>
										  </div>
										</div>
