...
@section('content')
 ...
 <div class="">
	...
	<li id="search_toggle"><a href="{{route('admin.users')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('admin.user.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_fields" label="Fields">
													<option data-type="Complex" value="id">Email</option>
												</optgroup>
											</select>
										  </div>
										</div>
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
												<option data-type="Complex" value="id">ID</option>
													<option data-type="Complex" value="email">Email</option>
											</select>
										  </div>
										</div>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a style="margin-right:7px" class="btn btn-xs btn-success" href="{{route('admin.users.edit',$item->id)}}">
										<i class="fa fa-pencil"></i></a>
										@if(Auth::user()->id == $item->id)

										@else
										<a style="margin-right:7px" class="btn btn-xs btn-warning" href="{{route('admin.users.delete',$item->id)}}">
