...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Buildings</h1>
	...
	<li id="search_toggle"><a href="{{route('buildings.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('building.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							<thead>
								<tr>
									...
									<th id="th_ap2">Complex</th>
									<th id="th_ap">City</th>
									<th id="th_ap">State</th>
									<th id="th_ap">Zip</th>
									<th id="th_mg"></th>
								</tr>
							</thead>
