...
<li id="search_toggle"><a href="{{route('property.overview')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
...
<div class="row">
    <div class="col-md-12">
      ...
      <form name='dbForm' id='dbForm' action="{{route('propertyOverview.filter')}}" method="POST">
        @csrf
        <div class="property_selector">
            <select onChange="autoSubmit();" name="property" id="property_id"  data-placeholder="Select Property" class="chosen-select">
                <option value="">Filter By Complex</option>
