...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Payments</h1>
	...
	<li id="search_toggle"><a href="{{route('payment.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('payment.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_filters" label="Filters">
													<option data-type="Complex" value="building">Type</option>
												...
												<optgroup class="optgroup_fields" label="Fields">
													...
													<option data-type="Complex" value="start_time">Reference</option>
													<option data-type="Complex" value="start_time">Amount</option>
													<option data-type="Complex" value="start_time">Amount Paid</option>
													<option data-type="Complex" value="start_time">Date</option>
													<option data-type="Complex" value="start_time">Paid Date</option>
													<option data-type="Complex" value="end_time">Related to</option>
												</optgroup>
											</select>
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
												<option data-type="Complex" value="id">ID</option>
													<option data-type="Complex" value="reference">Reference</option>
													<option data-type="Complex" value="amount">Amount</option>
													<option data-type="Complex" value="amount_paid">Amount Paid</option>
													<option data-type="Complex" value="created_at">Date</option>
													<option data-type="Complex" value="date_paid">Paid Date</option>
											</select>
										  </div>
										</div>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							<thead>
								<tr>
									...
									<th id="th_ap2">Date</th>
									<th id="th_ap">Address</th>
									<th id="th_ap">Type</th>
									<th id="th_ap">Tenant</th>
									<th id="th_ap">Amount</th>
									
									<th id="th_ap">Date Paid</th>
									<th id="th_ap">Amount Paid</th>
									<th id="th_ap">Transaction Reference</th>
									<th id="th_ap">Status</th>
