...
@section('content')
 ...
 <div class="">
                <h1 class="mainTitle"> Complexes</h1>
	...
	<li id="search_toggle"><a href="{{route('admin.complex')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
	<li id="export"><a class="export_link" href="{{route('admin.complex.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
										...
										<div class="search_area_container form-group">
											<div class="col-lg-2">
											  <span class="search_area_text_container">
                                                <select class="search_area_text form-control" name="search_text" id="">
										...
										<div class="form-group">
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
													...
													<option data-type="Complex" value="name">Complex</option>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$item->name}}</td>
									<td>
										<a style="margin-right:7px" class="btn btn-xs btn-success" href="{{route('buildings.search',$item->id)}}">
										<i class="fa fa-search"></i></a>
										<a style="margin-right:7px" class="btn btn-xs btn-success" href="{{route('admin.complex.edit',$item->id)}}">
										<i class="fa fa-pencil"></i></a>
										<a style="margin-right:7px" class="btn btn-xs btn-warning" href="{{route('admin.complex.delete',$item->id)}}">
