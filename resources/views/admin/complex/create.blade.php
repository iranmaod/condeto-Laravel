...
<div class="">
    <h1 class="mainTitle">    New Complex
</h1>
...
<div class="col-md-12">
    ...
    <section class="widget admin_view_record" id="RecordSection">
        ...
        <section class="widget-content">	
            ...
            <form action="{{route('admin.complex.create')}}" method="post">	
                @csrf
                <div class="form_field">
                    <label style="width:100%">Complex Name: </label>
                    <input type="text" id="complex_name" name="complex_name" value="" />
                </div>
                
                <div class="form_field">
                    <label style="width:100%">Payment Processing Fee %: </label>
                    <input type="text" id="stripe_fee" name="stripe_fee" value="3.25" />%
                </div>
