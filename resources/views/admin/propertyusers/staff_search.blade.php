...
<li id="search_toggle"><a href="{{route('staff.index')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
<li id="export"><a class="export_link" href="{{route('staff.export')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
						...
						<table class="table table-striped table-bordered table-hover datatable">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$item->role}}</td>
									<td>
										<a style="margin-right:7px" class="btn btn-xs btn-warning" href="{{route('staff.remove',$item->id)}}">
