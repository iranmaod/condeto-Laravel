...
<li id="search_toggle"><a href="{{route('admin.complex.manager')}}" >Refresh <i class="fa fa-refresh"></i></a></li>
...
<div class="col-md-12">
		...
		<form  method="POST" action="{{route('admin.complex.manager.search')}}">
			@csrf
			<section class="widget-content">
				<div class="filter_section_row" data-label="Search">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a style="margin-right:7px" class="btn btn-xs btn-warning" href="{{route('admin.manager.delete',$item->id)}}">
