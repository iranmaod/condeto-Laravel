...
@section('content')
 ...
 <div class="">
	...
	<li id="export"><a class="export_link" href="{{route('tenants.search')}}" target="_blank">Export CSV <i data-active-class="fa-download" data-not-active-class="fa-download" class="fa fa-download"></i></a></li>
										  ...
										  <div class="col-lg-2">
											<select class="form-control search_area_field" name="name">
												...
												<optgroup class="optgroup_filters" label="Filters">
													<option data-type="Complex" value="building_complex">Role</option>
													<option data-type="Complex" value="building_complex">Building</option>
												</optgroup>
												<optgroup class="optgroup_fields" label="Fields">
													<option data-type="Complex" value="building_complex">First Name</option>
													<option data-type="Complex"  value="city">Last Name</option>
										...
										<div class="form-group">
										  ...
										  <div class="col-lg-2">
											<select class="form-control sort_area_field" name="sortby">
													...
													<option data-type="Complex" value="city">First Name</option>
													<option data-type="Complex" value="state">Last Name</option>
